...
!       ! serial#,  status,      fileID
    ...
    do i = 1, 1000000
        ...
        if (mod(i,10) == 0) then
            write(num_position(1), lt//eform4//rt) t, tmp_v, tmp_x, analytic(t)
